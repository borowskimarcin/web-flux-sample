 ...
 */
public class RepositoryDetailsDeserializer extends JsonObjectDeserializer<RepositoryDetails> {
    @Override
    protected RepositoryDetails deserializeObject(JsonParser jsonParser, DeserializationContext deserializationContext, ObjectCodec objectCodec, JsonNode jsonNode) throws IOException {
