 ...
 */
public class RepositoryDetailsDeserializer extends JsonObjectDeserializer<MaybeRepositoryDetails> {
    @Override
    protected MaybeRepositoryDetails deserializeObject(JsonParser jsonParser, DeserializationContext deserializationContext, ObjectCodec objectCodec, JsonNode jsonNode) throws IOException {
        ...
        return new MaybeRepositoryDetails(fullName, description, cloneUrl, stars, createdAt);
    }
}
